...
class Membership < ApplicationRecord
  ...
  after_destroy_commit -> { broadcast_action_later_to(user, action: :append, target: 'all_channels_without_user', partial: 'memberships/list_channels_without_user', locals: { channel: channel, membership: nil }) } # rubocop:disable Layout/LineLength, Style/HashSyntax
end
